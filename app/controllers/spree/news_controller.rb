module Spree
  class NewsController < Spree::BaseController
    ...
    def self.posts
      ...
      posts << {
        "title" => "A little write up from our friends at green-label.com",
        "date" => "07-10-2014",
        "images" => ["//newyorksunshine-production.s3.amazonaws.com/news/news-green-label.jpg"],
        "clickthrough_link" => "http://green-label.com/style/new-york-sunshine-spring-summer-2014-lookbook/"
      }

      posts << {
        "title" => "Complex Style x New York Sunshine",
        "date" => "06-16-2014",
        "images" => ["//newyorksunshine-production.s3.amazonaws.com/news/news-complex-style.jpg"],
        "clickthrough_link" => "http://www.complex.com/style/2014/06/new-york-sunshine-releases-spring-summer-2014-lookbook"
      }


      posts << {
        "title" => "Check out our interview with SlamxHype",
        "date" => "06-02-2014",
        "images" =>["http://newyorksunshine-production.s3.amazonaws.com/news/news-five-minutes-nys-1.jpg", "http://newyorksunshine-production.s3.amazonaws.com/news/news-five-minutes-nys-2.jpg", "http://newyorksunshine-production.s3.amazonaws.com/news/news-five-minutes-nys-3.jpg"],
        "clickthrough_link" => "http://slamxhype.com/style/5-minutes-new-york-sunshine-surf-basketball-boutique-heart-hamptons/"
      }
      ...
      posts << {
        ...
        "images" => ["//newyorksunshine-production.s3.amazonaws.com/news/hamptons-house-wism.jpg"]
      }
      ...
      posts << {
        ...
        "clickthrough_link" => "//newyorksunshine-production.s3.amazonaws.com/news/beach-magazine-sunshine-kid.pdf",
        "tags" => ["press"]
      }
      ...
      posts << {
        ...
        "clickthrough_link" => "//newyorksunshine-production.s3.amazonaws.com/news/new-york-post-2013.pdf",
        "tags" => ["press"]
      }
