Deface::Override.new(
  ...
  :text => "<%= tab :feed_items, :surf_club, :lookbooks, :slides, :slide_images, :posts, :stockists, :about, :returns_exchanges, :contents, :label => 'Content', :icon => 'file-text', :url => '/admin/feed_items' %>")
